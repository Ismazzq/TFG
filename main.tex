...
\setlength{\headheight}{25.2232pt}   % Evita warning de fancyhdr
...
\input{capitulos/cap02_marco_institucional}
\input{capitulos/cap03_marco_teorico}
\input{capitulos/cap04_datos}
\input{capitulos/cap05_metodologia}
\input{capitulos/cap06_resultados}
\input{capitulos/cap07_discusion}
\input{capitulos/cap08_limitaciones}
\input{capitulos/cap09_conclusiones}
